...
public class MQTTBrokerKeyStoreTest {
    ...
    private static final String CA_CERT = "-----BEGIN CERTIFICATE-----\n" +
        ...
        "7YytSBhlUbgLCEE/IJVbD7aM9vn1t63zqJAnVXsqs5DTvf5+2qBzD0+gkkuSTbVj\n" +
        "67kQAMZs/MBVR2+94Ka5jAPSmotUwJADNQHKD5wB1vLc4vi7TfyDCA/dG0WtDmrx\n" +
        "knISpDCZWWbdcCNFfZVmHGg7F5VBVUCcrB2bz+E9W1PCBYyMCrEJyrtxrt+w\n" +
        "-----END CERTIFICATE-----\n";
    ...
    void GIVEN_MQTTBrokerKeyStore_WHEN_updateServerCertificate_called_THEN_success() throws Exception {
        ...
        FileInputStream is = new FileInputStream(mqttBrokerKeyStore.getJksPath());
        KeyStore keystore = KeyStore.getInstance(KeyStore.getDefaultType());
        String password = mqttBrokerKeyStore.getJksPassword();
        char[] passwd = password.toCharArray();
        keystore.load(is, passwd);
        Assertions.assertEquals(pemToX509Certificate(IOT_CERT), (keystore.getCertificate("pk")));
    }
    ...
    void GIVEN_MQTTBrokerKeyStore_WHEN_updateCertificates_called_THEN_success() throws Exception {
        ...
        Assertions.assertEquals(pemToX509Certificate(DEVICE_CERT_1), (keystore.getCertificate("device1")));
        ...
        Assertions.assertEquals(pemToX509Certificate(DEVICE_CERT_2), (keystore.getCertificate("device2")));
    }
